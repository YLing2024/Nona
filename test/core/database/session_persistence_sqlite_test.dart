...
import 'package:nona_chat/core/services/session_persistence_sqlite.dart';
...
void main() {
  ...
  setUp(() async {
    ...
    final opened = await openNonaDatabase(forceMemory: true);
    if (opened == null) {
      // 原因需在 CI 日志可见（可 grep SKIP）
      // ignore: avoid_print
      print('SKIP: sqlite3 不可用（openNonaDatabase 返回 null）');
